...
export default class View3 extends React.Component {
    ...
    renderView = (parent, children) => {
        ...
        if (children != null && children.length > 0) {
            for (let child of children) {
                ...
                let childDomNode = React.createElement(antd[child.title], { key: child.key, ...child.props }, tmp)
    ...
    render() {
        ...
        let ssf = React.createElement(antd['Layout'], { width: '100%', height: '100%' }, this.renderView(this.props.store.treeData))
        return ssf;
        // let s = []
